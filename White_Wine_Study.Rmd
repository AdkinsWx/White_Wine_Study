...
```
> The plots above show first weak negative correlation between quality and density and the rather strong correlation between alcohol and density. The latter plot agrees with the chemical properties of alcohol being less dense than water. The first graph between quality and denisty states a very small correlation
